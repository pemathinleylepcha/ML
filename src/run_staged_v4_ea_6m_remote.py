...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a 6-month staged_v4 validation from an EA-built M1 candle bundle.")
    parser.add_argument("--output-root", required=True)
    parser.add_argument("--candle-root", required=True)
    parser.add_argument("--tick-root", required=True)
    parser.add_argument("--start", default="2025-10-01 00:00:00")
    parser.add_argument("--end", default="2026-04-06 23:59:59")
    parser.add_argument("--device", choices=("auto", "cpu", "cuda"), default="cpu")
    parser.add_argument("--max-folds", type=int, default=32)
