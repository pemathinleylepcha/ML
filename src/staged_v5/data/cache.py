...
from staged_v5.config import FX_TRADABLE_NAMES
from staged_v5.config import TPO_SOURCE_TIMEFRAME
from staged_v5.contracts import BTCFeatureBatch, FXFeatureBatch, TimeframeFeatureBatch
from staged_v5.data.bridge_features import build_bridge_batches
from staged_v5.data.btc_features import build_btc_feature_batch, build_btc_timeframe_batch
from staged_v5.data.dataset import StagedPanels, generate_synthetic_panels, load_staged_panels
from staged_v5.data.fx_features import build_fx_feature_batch, build_fx_timeframe_batch
from staged_v5.utils.runtime_logging import stage_context, write_status
...
def prepare_staged_cache(
    ...
    gc.collect()
    from staged_v5.utils.runtime_logging import enforce_memory_guard
